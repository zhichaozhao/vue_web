    ...
    <div>
        ...
        <div style="position: relative">
            <video id="my-video" class="video-js" controls preload="auto" width="830" height="466.8"
                   poster="/static/images/about/a.png" data-setup="{}">
        ...
        <a class="about-download" href="/static/pdf/aboutus2016.pdf" target="_blank">下载云SPACE公司介绍PDF<span>↓</span></a><br>
        <a class="about-download" href="/static/pdf/ysp_brief_2016.pdf" target="_blank">Download 2016 YUN SPACE Brief<span>↓</span></a>
        ...
        <ul class="about-qrcode clearfix">
            <li>
                <img src="/static/images/about/qrcode1.jpg">
                <p>云SPACE移动版</p>
            </li>
            <li>
                <img src="/static/images/about/qrcode_info.png">
                <p>微信订阅号<br>关注活动资讯</p>
            </li>
            <li>
                <img src="/static/images/about/qrcode_space.png">
                <p>微信服务号<br>关注场地资源</p>
            </li>
            <!--<li>-->
            ...
            <!--</li>-->
            <li>
                <img src="/static/images/about/ygj_new.png" height="100" width="100">
